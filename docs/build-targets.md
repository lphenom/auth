...
| `CodeSenderInterface` (email) | `UniSenderEmailSender` (**shared,kphp**) | `curl_*` — KPHP-совместимо |
| `CodeSenderInterface` (SMS) | `MirSmsSender` (**shared,kphp**) | `curl_*` — KPHP-совместимо |
...
| `MirSmsSender` | `curl_*` — KPHP-совместимо |
